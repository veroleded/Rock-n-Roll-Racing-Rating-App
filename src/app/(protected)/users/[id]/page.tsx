...
export default function UserPage() {
  ...
  if (error || !user) {
    return (
      <div className="flex items-center justify-center h-[calc(100vh-4rem)]">
        <div className="text-destructive">{error?.message || t('common.failedToLoadUser')}</div>
      </div>
    );
  }
                          ...
                          <div className="space-y-6">
                            <div className="grid grid-cols-3 gap-4">
                              <div className="space-y-1 text-center">
                                <p className="text-sm font-medium">{t('common.wins')}</p>
                                <p className="text-xl font-bold text-green-500">
                                  {user.stats.wins}
                                </p>
                              </div>
                              <div className="space-y-1 text-center">
                                <p className="text-sm font-medium">{t('common.losses')}</p>
                                <p className="text-xl font-bold text-red-500">
                                  {user.stats.losses}
                                </p>
                              </div>
                              <div className="space-y-1 text-center">
                                <p className="text-sm font-medium">{t('common.draws')}</p>

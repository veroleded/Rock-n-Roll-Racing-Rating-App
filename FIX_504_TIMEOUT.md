...
- Настроены параметры PostgreSQL:
  ...
  - `idle_in_transaction_session_timeout=30000` - таймаут для зависших транзакций (30 секунд)
  - `statement_timeout=30000` - таймаут для долгих запросов (30 секунд)
- Добавлено ожидание готовности PostgreSQL перед запуском приложения
